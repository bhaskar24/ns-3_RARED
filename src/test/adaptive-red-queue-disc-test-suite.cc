...
void
AdaptiveRedQueueDiscTestCase::RunRefinedAdaptiveRedDiscTest (StringValue mode)
{
    ...
    */
    ...
    NS_TEST_EXPECT_MSG_NE (st.unforcedDrop, st.forcedDrop, "forcedDrop should not be equal to unforcedDrop");
